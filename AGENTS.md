# Agent Operating Instructions for ../docfresh

This file defines how AI agents and human maintainers should work in `../docfresh`.
...
- Default branch: ``
- Package manager: ``
- Primary verification command: `npm run release:check`
...
6. Run `npm run release:check` or a smaller targeted check when appropriate.
7. Commit atomically.
